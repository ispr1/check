...
import { Building2, ArrowLeft, Eye, EyeOff, Sparkles } from 'lucide-react';
...
export default function CompanyLoginPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0f] relative overflow-hidden flex items-center justify-center px-4">
            ...
            <div className="absolute top-1/3 left-1/3 w-[500px] h-[500px] bg-blue-500/10 rounded-full blur-[150px]" />
            ...
            >
                <div className="card p-8">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-white/40 text-sm">Manage your organization and verifications</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold py-3 rounded-xl hover:shadow-lg hover:shadow-blue-500/30 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                        >
                            {isLoading ? (
                                <>
